        ...
        <div class="col-md-6 my-2">
          <div class="form-floating">
            <Field
              ...
              v-model="getUserRegistration.lastName"
            />
      ...
      <div class="col-md-12 my-2">
        <div class="form-floating">
          <Field
            ...
            v-model="getUserRegistration.email"
          />
        ...
        <div class="col-md-6 my-2">
          <div class="form-floating">
            <Field
              ...
              v-model="getUserRegistration.confirmPassword"
            />
      ...
      <div class="row">
        ...
        <div class="col-md-6 my-2">
          <div class="form-floating">
            ...
            />
            <label class="text-secondary-emphasis" for="brand">{{ $t('VehicleName') }}</label>
        ...
        <div class="col-md-6 my-2">
          <div class="form-floating">
            <Field
              ...
              type="text"
              class="form-control required"
              :class="{ 'is-invalid': errors.registrationPlate }"
              id="registrationPlate"
              :placeholder="$t('VehicleRegistrationPlate')"
              v-model="getUserRegistration.vehicle.registrationPlate"
            />
      ...
      <div class="checkbox my-2">
        <div class="form-check">
          <Field
            ...
            name="agreement"
            type="checkbox"
            class="form-check-input bg-success required"
