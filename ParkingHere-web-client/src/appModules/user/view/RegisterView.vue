<template>
  <div
    class="login-form position-absolute top-50 start-50 translate-middle p-3 bg-dark col-12 col-sm-8 col-lg-6 col-xl-4"
    data-bs-theme="dark"
  >
    <form>
      <div class="d-flex align-items-center justify-content-center">
        <div
          class="person-icon position-relative rounded-circle border border-3 border-success me-3"
        >
          <font-awesome-icon
            :icon="['fa', 'user']"
