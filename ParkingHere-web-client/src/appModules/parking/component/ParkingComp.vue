<template>
  <div v-if="parking"
    ...
    <div
      ...
      <div class="fs-5 mt-lg-2 d-flex flex-column align-items-start align-items-lg-end">
        <span class="fw-bold text-success">{{ $t('From') }} {{ lowestPrice }} {{ $t('Currency') }}</span>
  ...
  <div v-else
    ...
    <div class="col-6 ms-3 p-3 d-flex flex-column justify-content-between h-100 placeholder placeholder-glow">
